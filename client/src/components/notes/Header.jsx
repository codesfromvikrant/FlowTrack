...
const Header = () => {
  ...
  return (
    <div className="flex justify-start items-center md:flex-nowrap flex-wrap gap-3 text-slate-400">
      <button className="flex justify-start items-center gap-2 shadow-md bg-primary border-[1px] border-gray-800 hover:bg-blue-700 transition-all duration-500 py-3 px-5 rounded-lg w-max text-gray-200">
